...
<strong>2. <a href = "https://wmpjrufg.github.io/GIT0001/002-3.html#add">Add</a>:</strong> Toda vez que um arquivo novo é criado, ele precisa ser adicionado no rastreamento do Git antes do comando <a href = "#commit">Commit</a>, e essa é a função deste comando.
</p>

<p>
Acesse <a href = "https://git-scm.com/docs/git-add/pt_BR">aqui</a> a documentação completa.<br><br>
</p>
...
<p>
Acesse <a href = "https://git-scm.com/docs/git-commit/pt_BR">aqui</a> a documentação completa.<br><br>
</p>


<p align = "justify" id = "push">
<strong>4. <a href = "https://wmpjrufg.github.io/GIT0001/002-4.html#push">Push</a>:</strong> Geralmente realizado após o comando <a href = "#commit">Commit</a>, e tem por objetivo levar as alterações feitas até o repositório online.
</p>

<p>
Acesse <a href = "https://git-scm.com/docs/git-push/pt_BR">aqui</a> a documentação completa.<br><br>
</p>
...
<p>
Acesse <a href = "https://git-scm.com/docs/git-pull/pt_BR">aqui</a> a documentação completa.<br><br>
</p>
...
<p>
Acesse <a href = "https://git-scm.com/docs/git-branch">aqui</a> a documentação completa.<br><br>
</p>
