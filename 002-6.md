...
É por meio do ID de identificação - denominado hash ou SHA - do <i>commit</i>, podemos reverter qualquer <i>git commit</i> executado.
...
```
<p>
Reverte o último Commit feito. <br>
