...
```
<p>
É possível editar a mensagem do último <i>commit</i> feito. Após executar este comando, o terminal mostrará o caminho do arquivo onde está a mensagem de <i>commit</i>, e é só clicar nela. Caso o arquivo ainda não exista, será possível editar no próprio terminal
</p>
