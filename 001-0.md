...
<br><br>
A <a href = "#fig12">Figura 1.2</a> indica uma busca simples no Google pela palavra chave <b>Elementos Finitos</b>. Nessa busca possível verificar repositórios de usuários que tem como foco a vertente Elementos Finitios.
</p>

<p align = "left" id = "fig12"><b>Figura 1.2</b> Representação dos repositórios no GitHub.</p>
<center><img src = "assets/images/fig12.png" width = "100%"></center>
